...
namespace ProyectoFinal.Controllers
{
    public class MatriculaController : Controller
    {
        ...
        public JsonResult GetMatriculas (int? idperiodo, int? idoferta, int? idmateria, int? idalumno, int? idestado)
        {
        ...
        public PartialViewResult EditMatricula(int IdMatricula)
        {
            Matricula objMatricula = new Matricula();
